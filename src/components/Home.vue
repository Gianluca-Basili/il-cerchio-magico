...
<template lang="">
    <div>
        <div>
            <div class="container-fluid my-5 col-md-12 bg-color-person">
                <div class="row margin">
                    ...
                    <div class="colori col-sm-12 col-md-6 col-lg-6 my-5">
                        
                    </div>
                </div>
                <div class="row my-5 margin">
                    <div class="col-sm-12 col-md-6 col-lg-6  bambini my-5">
                        
                    </div>
                    
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        <h1>Mission</h1>
                        Siamo un soggetto attivo che partecipa, in stretta collaborazione con le istituzioni, con il no-profit e con le risorse formali ed informali del territorio, alla costruzione del benessere della comunità ed all’integrazione sociale dei cittadini, attraverso la promozione, la progettazione e la realizzazione di servizi psico-socio-sanitari ed educativi.<br>
                        Il focus principale dell’associazione é il benessere del minore e delle famiglie ,senza mai perdere di vista questo importante principio.
                    </div>
                </div>
            ...
            <div class="container-fluid">
                <div class="row ">
                    <div class="col-12 text-center fs-4">
                        <p><strong>"Quando due esseri si vogliono bene è come se ci fosse un piccolo cerchio magico, che stà intorno a loro".<br></strong>  <i>Il Cerchio magico di Susanna Tamaro</i></p>
                    </div>
                </div>
            </div>
        </div>
...
<style lang="scss" scoped>
    ...
    .colori{
        background-image: url(../assets/img/colori.avif);
        height: 300px;
        width: 35%;
        border-radius: 5%;
    ...
    .bambini{
        background-image: url(../assets/img/fotohome2.JPG);
        height: 300px;
        width: 35%;
        border-radius: 5%;
        background-position: center;
